...
?>
<html>
<title>Gestione Permessi - Elenco Giustificazioni</title>
<meta charset="UTF-8">
...
<header class="w3-container w3-center testata" style="padding:40px 16px">
  <h1 class="w3-margin w3-jumbo testata">ELENCO GIUSTIFICAZIONI</h1>
</header>
...
//RICERCA
if(isset($_GET["giustificazioni_studente"])){
    ...
    echo "<th>DATA</th><th>TIPO</th><th>GENITORE</th><th>ASSENZA DAL</th><th>ASSENZA AL</th><th>GIUSTIFICATO</th>";
    while($row= mysqli_fetch_array($result)){
        $query1= "SELECT * FROM giustificazione WHERE fkUtente='".$row["idUtente"]."' ORDER BY data ASC";
