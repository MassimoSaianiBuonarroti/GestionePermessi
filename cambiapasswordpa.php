...
<header class="w3-container w3-red w3-center" style="padding:40px 16px">
  <h2 class="w3-margin w3-jumbo">Cambia Password</h2>
</header>

<!-- First Grid -->
<div class="w3-row-padding w3-padding-64 w3-container">
    <form name="cambiapasswordpa" action="#" method="POST">                       
    ...
    if(isset($_POST["modificapassword"])){
        ...
        if($nuovapassword == $nuovapassword_ripeti && $nuovapassword!="" && $nuovapassword_ripeti!=""){
