                ...
                <div class="main">      
                    <div class="login-form adatta_testo">
                        ...
                        if (isset($_GET['err'])) 
                        {
                            ...
                            {
                                echo '<b><p style="color:blue;font-size:16px">Il suo account non è presente nell"elenco dei genitori. <br>Inviare una mail a <a href=mailto:"' . $__settings->config->refEmail . '">' . $__settings->config->refEmail . '</a> segnalando il problema</p></b>';
                            }
